    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('kaprodi.profile.update') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            @if($kaprodi->signature)
                                <div class="border rounded p-4 bg-gray-50 text-center flex flex-col justify-center items-center h-48">
                            ...
                            <div class="border rounded p-4 bg-white">
                                <p class="text-xs font-semibold text-gray-700 mb-2">{{ $kaprodi->signature ? 'Ganti Tanda Tangan Baru' : 'Buat Tanda Tangan' }}</p>
                                ...
                                <p class="text-xs text-gray-500 mt-2 italic">Gunakan mouse atau sentuhan (di HP/Tablet) untuk menandatangani pada kotak di atas.</p>
                            </div>
                        </div>
                    </div>
